...
```text
หลังจากรับค่า string มา 5 ค่าหลังจากนั้นทำการใส่กรอบมัน
```
...
```text
Step 1: สร้างค่าอินพุท 5 ตัว
Step 2: เอาเข้า if else
Step 3: ใส่กรอบ
...
```text
Step 1: for loop เอา 5 ตัวแปร
Step 2: หา Len ที่มันมากที่สุด
Step 3: เข้า loop ทำกรอบ

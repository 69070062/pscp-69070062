...
```I use teh if else because it easy for me and it just if the color match the mother color so i can use == or in to make it know
...
```Because two of them is mother color
...
```Because i didnt choose this mother color last time

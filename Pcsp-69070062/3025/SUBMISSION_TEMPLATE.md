...
```using if else and using the date and specific date to cahnge the season
...
```text
Step 1:use if else and then 
Step 2:using the specific date to change the season
Step 3:
```
...
```it's the date that chnage the season
...
``again the date that change the season

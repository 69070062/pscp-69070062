...
```text
รับค่าความหนาของแถบ กับ จำนวนดอกไม้  แล้วหาว่า ดอกไม้ต้นที่ N อยู่ในแถบลำดับที่เท่าไหร่.
...
```text
รับ L = ความหนาแถบ และ N = ช่องสุดท้ายที่ปลูก
นับจำนวนช่องสะสมเป็น 1, 1+1, 1+1+2, 1+1+2+3
วนจนจำนวนช่องสะสมเกินหรือถึง N
ตัวแปร floor จะบอกว่าไปถึงแนวทแยงลำดับที่เท่าไร
เอา floor / L แล้วปัดขึ้น เพื่อหา หมายเลขแถบ
```

...
```text
just using string slicing ::-1 to change the direction 
of the input
```
...
```
kust using the string slciing and the plan work
```
...
```qwerty because just wanna check if the code work
...
```It has more than one uppercase
